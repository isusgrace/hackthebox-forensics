...
'Sp00ky Theme.zip'
```
คำสั่ง ls ใช้แสดงรายการไฟล์และไดเร็กทอรีที่มีอยู่ในไดเร็กทอรีปัจจุบัน ในส่วนนี้เราต้องการตรวจสอบเฉย ๆ ว่าไฟล์ถูกย้ายมาหรือไม่
```
┌──(kali㉿kali)-[~/Downloads/isusgrace03]
...
เพิ่มเติม
- ฉันไม่สามารถวางรูปในหน้้า CyberChef ได้ เนื่องจากเกิดปัญหานิดหน่อย ฉันจะรีบหาทางแก้โดยเร็วที่สุด
